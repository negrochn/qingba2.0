...
| `--bg` | `#ededed` | BG-0 |
| `--card` | `#ffffff` | BG-2 |
| `--card2` | `#f7f8fa` | ≈ BG-3（三级背景 / 卡片内嵌底、次级填充） |
| `--text` | `rgba(0,0,0,.9)` | FG-0（主文字） |
| `--text2` | `#737373`（FG-1 次级，.55 黑） | FG-1（标题 / 说明 / cell 值） |
| `--text3` | `#b2b2b2`（FG-2，.3 黑） | FG-2（三级 / 占位） |
| `--divider` | `#e5e5e5` | ≈ FG-3（.1 黑≈#e6e6e6） |
| `--brand` | `#07c160` | BRAND |
| `--danger` | `#fa5151` | RED |
| `--cell-active` | `#f5f5f5` | ≈ BG-COLOR-ACTIVE（浅） |

深色档：`--bg #111`、`--card #1c1c1e`、`--card2 #232326`、`--text rgba(255,255,255,.8)`、`--text2 rgba(255,255,255,.5)`、`--text3 rgba(255,255,255,.3)`、`--divider rgba(255,255,255,.1)`、`--brand #07c160`、`--danger #fa5151` ——对应 BG-0 / BG-2 / BG-3 / FG-0 / FG-1 / FG-2 / FG-3 / BRAND / RED 深色档（RED 深浅一致）。
...
- 统一写作 `calc(Nrpx * var(--fs, 1))`，随字体档位（小 / 标准 / 大 / 特大）缩放

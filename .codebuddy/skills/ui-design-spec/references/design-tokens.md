...
| rpx | px | 定位 | 典型用法 |
|---|---|---|---|
| 34 | 17 | 主文 | `.weui-cell__bd_text`、按钮、dialog 标题 / 正文 |
| 30 | 15 | 长文正文 | 关于页正文（`about`）、`.weui-panel__hd`、空状态文案；**仅限长文 / 说明**，页面内的标题、值、文案一律不用 |
| 28 | 14 | 次级 | 分组标题、说明、cell 右侧值、关键要点文字 |
| 24 | 12 | 辅助 | `.weui-cell__desc`、徽标、箭头、角标 |

- 统一写作 `calc(Nrpx * var(--fs, 1))`，随字体档位（小 / 标准 / 大 / 特大）缩放
- **标准 UI 元素**（列表标题 / 值 / 按钮 / 标签 / 卡片内文案）只用 34 / 28 / 24 三档；`30rpx`(15px) 仅用于长文正文 / 说明 / 空状态（如 `about` 页）

...
| 34 | 17 | 主文 | `.weui-cell__bd_text`、按钮、dialog 标题 / 正文、**文章页正文与列表项**（WeUI article 正文基准即 17px / FG-0） |
...
- **标准 UI 元素**（列表标题 / 值 / 按钮 / 标签 / 卡片内文案）只用 34 / 28 / 24 三档；`30rpx`(15px) 仅用于长文说明 / 面板标题 / 空状态
...
- 大号数字（40 / 44 / 56 / 72rpx）用于统计与时长展示，不受上表约束
